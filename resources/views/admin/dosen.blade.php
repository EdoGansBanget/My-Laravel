        ...
        <div class="container mt-4">
            <div class="row mt-3">
                <div class="col">
                    <form action="{{ route('admin.dosen') }}" method="GET">
                        ...
                        <div class="input-group">
                            <input type="search" name="search" class="form-control rounded" placeholder="Cari Dosen"
                ...
                <div class="col text-end">
                    <a class="btn btn-success" href="{{ route('admin.tambahDosen') }}"
            ...
            <table class="table mt-4">
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr>
                        ...
                        <td>
                            <img style="width: 50px" src="{{ asset('/images/' . $dosen->foto) }}" alt="foto dosen">
                        </td>
                        <td>{{ $dosen->nama }}</td>
                        <td>{{ $dosen->mata_kuliah }}</td>
                        <td>
                            <a class="btn btn-outline-warning" href="{{ route('admin.editDosen', $dosen->id) }}"><i
                                    class="fas fa-pen"></i></a>
                            <a class="btn btn-outline-danger" href="{{ route('admin.deleteDosen', $dosen->id) }}"><i
