...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarButtonsExample">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  active" href="#">Aktivitas RPL</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <h3>Aktivitas Rekayasa Perangkat Lunak Politeknik Negeri Bengkalis</h3>
        <div class="row">
            @foreach ($data as $aktivitas)
            <div class="col-3">
                <img class="rounded-4" style="object-fit: cover; width: 100%; aspect-ratio: 1/1"
                    src="{{ asset('/images/' . $aktivitas->gambar) }}" alt="Gambar Aktivitas" />
                <p class="mt-3">
                    <b>{{ $aktivitas->judul }} | {{ $aktivitas->tanggal }}</b> <br />
                    {{ $aktivitas->deskripsi }}
                </p>
            </div>
            @endforeach
